...
export const HoldersChatScreen = () => {
    ...
    // Fetch Data Hook
    const { asset: fetchedAsset, metrics: fetchedMetrics } = useAssetDetail(entityId, type as any);

    useEffect(() => {
        // If hook returned data (Supabase or Mock fallback inside hook)
        if (fetchedAsset && (type === 'ARTIST' || type === 'LABEL')) {
            setEntity(fetchedAsset);
            setMetrics(fetchedMetrics);
        } else if (type === 'PREDICTION') {
            const pred = require('../data/catalog').getPredictionById(entityId);
            setEntity({ ...pred, name: pred?.question, symbol: 'PRED' });
    ...
    }, [entityId, type, fetchedAsset, fetchedMetrics]);
            ...
            <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
                ...
                >
                    ...
                    <TradeSheet
                        ...
                        marketId={entity?.marketId} // Pass marketId

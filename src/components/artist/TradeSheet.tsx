...
const styles = StyleSheet.create({
    ...
    reviewCard: { backgroundColor: COLORS.surface, borderRadius: 16, padding: 20, marginBottom: 16, borderWidth: 1, borderColor: COLORS.stroke.settings },
    ...
    reviewDetails: { marginBottom: 32, gap: 24, backgroundColor: COLORS.surface, padding: 16, borderRadius: 16, borderWidth: 1, borderColor: COLORS.stroke.settings },
